...
function write_log($message) {
    $log_file = '/var/www/html/admin/abnormal_log.log';
...
if ($conn->connect_error) {
    die("系統錯誤：無法連線到資料庫。" . $conn->connect_error);
}
                ...
                <form action="abnormal.php" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                    ...
                    <div class="flex flex-col space-y-3">
                        ...
                        <button type="submit" name="export_csv" value="1" class="btn-secondary">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l3-3m-3 3l-3-3m0 0V4m0 0h7a2 2 0 012 2v7a2 2 0 01-2 2h-7a2 2 0 01-2-2v-7a2 2 0 012-2z" /></svg>
                            匯出 CSV
                        </button>
                        <?php endif; ?>
                    </div>
